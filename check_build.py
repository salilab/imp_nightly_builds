...
def main():
    ...
    f43_64 = 'pkg.f43-x86_64'    # Fedora 43 RPM
    ...
    c.add_cmake_log(f43_64, ['build', 'test'],
                    'packages/IMP-%s-1.fc43.x86_64.rpm' % repo.newlongver)
    ...
    if imp_lab_check:
        ...
        for m in ('isd_emxl',):
            incs = [release8, debug8, f43_64, fast8, coverage, win32,
