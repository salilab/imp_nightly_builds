...
class TestPage(object):
    ...
    def __init__(self):
        ...
        self.date, self.last_build_date, self.version, self.last_build_version \
                  = self.get_date_and_version(form)
            ...
            if self.date == self.last_build_date:
                ...
                if self.branch == 'develop':
                    print('Pre-built binaries ' \
                         '<a href="https://integrativemodeling.org/nightly/download/">' \
            ...
            if self.lab_only:
                ...
                for comp, url in \
                  [('multifit2',
                   ...
                   ('pynet',
                    'https://github.com/salilab/pynet'),
                   ('bbm',
                    'https://github.com/salilab/bbm'),
                   ('domino3',
